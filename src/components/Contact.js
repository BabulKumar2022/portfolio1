    ...
    return (
        <div name='contact' className='bg-[#0a192f]  w-full h-screen p-4 flex justify-center items-center'>
            <form method="POST" action='https://getform.io/f/9c572df0-9283-491d-8e92-43230c586a5e' className='flex flex-col max-w-[600px] w-full'>
                ...
                <input className='my-4 p-2 bg-[#435695] ' type="text" placeholder='Name' name='name' />
                <input className='my-4 p-2 bg-[#435695]' type="email" placeholder='Email' name='email' />
                <textarea className='my-4 p-2 bg-[#435695]' name="message" id="" placeholder='Message' rows="5"></textarea>
